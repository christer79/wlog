...
from work_hours import events_graph
...
class TestEvents(unittest.TestCase):
  def test_event_graph(self):
    ...
    self.assertEqual(events_graph(events),"[]        WWWWWWWWWWWWWWWW            []")
    ...
    self.assertEqual(events_graph(events),"[]WWWWWWWW                WWWW        []")
    ...
    self.assertEqual(events_graph(events),"[]         WWWWWWWWWWWWWWW            []")
